...
public class MP3PlayerGUI extends javax.swing.JDialog 
{
    ...
    private void initComponents() {
        ...
        getContentPane().add(Play, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 30, 90, 83));
        ...
        getContentPane().add(Stop, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 40, 70, 60));
        ...
        getContentPane().add(Display, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 340, 20));

        LoopCounter.setBackground(new java.awt.Color(255, 255, 153));
        LoopCounter.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        LoopCounter.setForeground(new java.awt.Color(255, 255, 255));
        LoopCounter.setText("jLabel1");
        getContentPane().add(LoopCounter, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, -1, 20));
